      ...
      <main className="min-h-screen bg-background flex flex-col items-center justify-center p-8">
        <div className="max-w-6xl w-full space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/puzzle"
              className="group relative overflow-hidden rounded-3xl border bg-card p-4 border-primary/30 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10"
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                <div className="p-4 rounded-2xl bg-primary/20 text-primary group-hover:scale-110 transition-transform duration-300 relative">
                  <Users size={36} />
                  <span className="absolute -top-1 -right-1 flex h-4 w-4">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-4 w-4 bg-primary text-[8px] items-center justify-center text-white font-black">NEW</span>
                  </span>
                </div>
                <div className="space-y-1">
                  <h2 className="text-xl font-bold">Instant Team Puzzle</h2>
                  <p className="text-sm text-muted-foreground">
                    Match with a partner instantly, solve a puzzle together, and unlock chat.
                  </p>
                </div>
                <span className="inline-flex items-center justify-center rounded-full bg-primary text-white px-4 py-1.5 text-sm font-black transition-all group-hover:px-6">
                  Play Now
                </span>
              </div>
            </Link>
            ...
            <Link
              href="/portal-wars"
              className="group relative overflow-hidden rounded-3xl border bg-card p-4 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                <div className="p-4 rounded-2xl bg-cyan-500/10 text-cyan-500 group-hover:scale-110 transition-transform duration-300 relative">
                  <Crosshair size={36} />
                  <span className="absolute -top-1 -right-1 flex h-4 w-4">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-500 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-4 w-4 bg-cyan-500 text-[8px] items-center justify-center text-white font-black">BETA</span>
                  </span>
                </div>
                <div className="space-y-1">
                  <h2 className="text-xl font-bold">Portal Wars</h2>
                  <p className="text-sm text-muted-foreground">
                    Cross-screen P2P shooter. Bullets travel through "portals" to your friend's screen.
                  </p>
                </div>
                <span className="inline-flex items-center justify-center rounded-full bg-cyan-500/10 px-4 py-1.5 text-sm font-medium text-cyan-600 group-hover:bg-cyan-600 group-hover:text-white transition-colors">
                  Enter Portal
                </span>
              </div>
            </Link>
            ...
            <Link
              href="/particles"
              className="group relative overflow-hidden rounded-3xl border bg-card p-4 border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10"
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                <div className="p-4 rounded-2xl bg-purple-500/20 text-purple-500 group-hover:scale-110 transition-transform duration-300 relative">
                  <Video size={36} />
                  <span className="absolute -top-1 -right-1 flex h-4 w-4">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-purple-500 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-4 w-4 bg-purple-500 text-[8px] items-center justify-center text-white font-black">HD</span>
                  </span>
                </div>
                <div className="space-y-1">
                  <h2 className="text-xl font-bold">Particle Studio</h2>
                  <p className="text-sm text-muted-foreground">
                    Create mesmerizing particle animations from text or images and export as HD video loops.
                  </p>
                </div>
                <span className="inline-flex items-center justify-center rounded-full bg-purple-500 text-white px-4 py-1.5 text-sm font-black transition-all group-hover:px-6">
                  Create Video
                </span>
              </div>
            </Link>
            ...
            <Link
              href="/laser-converter"
              className="group relative overflow-hidden rounded-3xl border bg-card p-4 border-red-500/30 hover:border-red-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/10"
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                <div className="p-4 rounded-2xl bg-red-500/20 text-red-500 group-hover:scale-110 transition-transform duration-300 relative">
                  <Zap size={36} />
                  <span className="absolute -top-1 -right-1 flex h-4 w-4">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-500 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-4 w-4 bg-red-500 text-[8px] items-center justify-center text-white font-black">HOT</span>
                  </span>
                </div>
                <div className="space-y-1">
                  <h2 className="text-xl font-bold">Laser Converter</h2>
                  <p className="text-sm text-muted-foreground">
                    Prepare images for laser engraving. Dithering, thresholding, and halftone effects.
                  </p>
                </div>
